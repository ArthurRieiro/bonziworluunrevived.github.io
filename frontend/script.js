...
function loadBonzis(a) {
    loadQueue.loadManifest([
        ...
        { id: "bonziTag", src: "./img/bonzi/tag.png" },
        { id: "bonziJew", src: "./img/bonzi/jew.png" },
        { id: "bonziPeedy", src: "./img/bonzi/peedy.webp" },
        { id: "bonziMerlin", src: "./img/bonzi/merlin.webp" },
        { id: "bonziMax", src: "./img/bonzi/max.webp" },
        { id: "bonziPowerFire", src: "./img/bonzi/power_fire.png" },
        { id: "bonziProgram", src: "./img/bonzi/program.webp" },
        { id: "bonziRonnie", src: "./img/bonzi/ronnie.png" },
        { id: "bonziWhite2", src: "./img/bonzi/white2.png" },
        { id: "bonziBrown", src: "./img/bonzi/brown.png" },
        { id: "bonziSgh", src: "./img/bonzi/sgh.png" },
        { id: "bonziHazzy", src: "./img/bonzi/hazzy.png" },
        { id: "bonziGlitch", src: "./img/bonzi/glitch_jitter.png" },
        { id: "bonziPink", src: "./img/bonzi/pink.png" },
...
var loadQueue = new createjs.LoadQueue(),
    loadDone = [],
    loadNeeded = ["bonziBlack", "bonziBlue", "bonziBrown", "bonziGreen", "bonziPurple", "bonziRed", "bonziPink", "bonziJew", "bonziRonnie", "bonziPowerFire", "bonziHazzy", "bonziMerlin", "bonziMax", "bonziPeedy", "bonziGlitch", "bonziProgram", "bonziSgh", "bonziTag", "bonziWhite2", "topjej"];
